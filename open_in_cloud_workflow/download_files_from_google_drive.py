...
def download_files_from_google_drive(work_dir: str, pattern: str, drive_root_directory: str) -> None:
    """Download all files matching at least one pattern to Google Drive."""
...
if __name__ == "__main__":  # pragma: no cover
    ...
    download_files_from_google_drive(work_dir, download_pattern, publisher.drive_root_directory)
