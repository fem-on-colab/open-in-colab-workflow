...
"""Tests for the open_in_cloud_workflow.get_fem_on_colab_installation_line package."""
...
def test_fem_on_colab_installation_line_name_and_url_at_fixed_commit() -> None:
